...
Route::put('/edit_petugas/{id}', 'Petugas@edit')->middleware('jwt.verify');
...
Route::put('/edit_kategori/{id}', 'KategoriController@update')->middleware('jwt.verify');
...
Route::put('/edit_artikel/{id}', 'Artikel@update')->middleware('jwt.verify');
Route::post('/tampil_artikel_brand', 'Artikel@tampil_brand');
Route::post('/tampil_artikel_kategori', 'Artikel@tampil_kategori');
...
Route::put('/edit_brand/{id}', 'BrandController@update')->middleware('jwt.verify');
